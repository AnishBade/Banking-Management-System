...
// Check to see if we have some POST data, if we do process it
	...
	if (isset($_POST['staff_name']) && isset($_POST['staff_address']) && isset($_POST['branch_id']) && isset($_POST['staff_password'])) 

	{

	    if (strlen($_POST['staff_name']) < 1 || strlen($_POST['staff_address']) < 1 || strlen($_POST['branch_id']) < 1 || strlen($_POST['staff_password']) < 1)

	    {

	        $_SESSION['error'] = "All fields are required";

	        header("Location: manager_staff_edit.php?staff_id=" . htmlentities($_REQUEST['staff_id']));
	    ...
	    $staff_address = htmlentities($_POST['staff_address']);

	    $branch_id = htmlentities($_POST['branch_id']);

	    $staff_password = htmlentities($_POST['staff_password']);
	    ...
	    $stmt = $pdo->prepare("
	    	...
	    	SET staff_name = :staff_name, staff_address = :staff_address, branch_id = :branch_id, staff_password = :staff_password
	...
	$stmt = $pdo->prepare("
	    ...
	    SELECT staff_id,staff_name,staff_address,branch_id,staff_password FROM staff 
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="card-body p-md-5 text-black">
                                                <h3 class="mb-5 text-uppercase">Staff Account Update Form</h3>
                                                <form action="" method="post">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-4">
                                                            <div class="form-outline">
                                                            <input type="text" id="form3Example1m" name="staff_name" value="<?php echo htmlentities($staff['staff_name']); ?>" class="form-control form-control-lg" />
                                                            <label class="form-label" for="form3Example1m">Staff name</label>
                                                            </div>
                                                        </div>
													...
													<div class="form-outline mb-4">
                                                        <input type="text" name="staff_address" value="<?php echo htmlentities($staff['staff_address']); ?>" id="form3Example8" class="form-control form-control-lg" />
                                                        <label class="form-label" for="form3Example8">Address</label>
                                                    </div>
													<div class="form-outline mb-4">
                                                        <input type="text" name="branch_id" id="branch_id" value="<?php echo htmlentities($staff['branch_id']); ?>" id="form3Example8" class="form-control form-control-lg" />
                                                        <label class="form-label" for="form3Example8">Branch Id</label>
                                                    </div>

                                                    <div class="form-outline mb-4">
                                                        <input type="text" name="staff_password" id="staff_password" value="<?php echo htmlentities($staff['staff_password']); ?>" id="form3Example97" class="form-control form-control-lg" />
